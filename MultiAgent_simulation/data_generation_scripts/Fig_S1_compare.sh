...
DATA_HOME=${HOME}/data/Fig_S1_compare # Absolute path to the the folder where data will be saved
mkdir -p ${DATA_HOME}
...
START_WITH_GIVEN_OPINION=0 # starting opinion
...
QUALITY_VALUES_LIST=([0.8,0.3,0.1] [0.8,0.4,0.1] [0.8,0.5,0.1] [0.8,0.55,0.1] [0.8,0.6,0.1] [0.8,0.7,0.1] [0.8,0.8,0.1] [0.8,0.625,0.1] [0.8,0.65,0.1] [0.8,0.675,0.1] [0.8,0.725,0.1] [0.8,0.75,0.1] [0.8,0.775,0.1])

# Values of the compare exploration rule parameter "epsilon"
PRE_STEP_SELF_STRENGTH_LIST=([0.05] [0.15] [0.25])
...
do
	...
	do
	    ...
	    sed -e "s|start|${1}|"                          \
		    ...
		    -e "s|JOBNAME|Fig_S1_compare_${QUALITY_VALUES}_${PRE_STEP_SELF_STRENGTH}|"   \
