...
DATA_HOME=${HOME}/data/Fig_S3_resample # Absolute path to the the folder where data will be saved
mkdir -p ${DATA_HOME}
...
do
	...
	do                                                                                         
        ...
        sed -e "s|start|${1}|"                          \
		    ...
		    -e "s|JOBNAME|Fig_S3_resample_${NUM_AGENT}_${AGENT_RADIUS}|"   \
