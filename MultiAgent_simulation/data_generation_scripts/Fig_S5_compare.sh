...
DATA_HOME=${HOME}/data/Fig_S5_compare # Absolute path to the the folder where data will be saved
mkdir -p ${DATA_HOME}
...
UPDATE_MODEL=[direct]
PROBABILISTIC_DISCOVERY_PROPORTION=[compare]
...
PRE_STEP_SELF_STRENGTH=[0.05] # Values of the compare exploration rule parameter "epsilon"
...
do
	...
	do
        ...
        sed -e "s|start|${1}|"                          \
		    ...
		    -e "s|JOBNAME|Fig_S5_compare_${NUM_AGENT}_${AGENT_RADIUS}|"   \
